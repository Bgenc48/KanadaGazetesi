---
title: "İlk Kanada Kışına Hazırlık: Giyimden Araba Lastiğine"
deck: "Kanada kışı ‘soğuk’ kelimesinin anlamını yeniden tanımlar. Ama doğru katmanlar, doğru lastikler ve birkaç yerel sırla, kış korkulacak değil keyfini çıkarılacak bir mevsime dönüşür."
section: "yasam"
author: "Yaşam Masası"
...
Uçlar kritiktir: **bere, eldiven/iki katlı eldiven, boyunluk** ve en önemlisi **su geçirmez, kaymaz tabanlı kışlık bot.** Ayakları ve başı koruyamayan en pahalı mont bile işe yaramaz.

## Araba kullananlar için: kış lastiği
...
> Soğukta araba aküleri çabuk biter; uzun park sonrası çalışmama ihtimaline karşı takviye kablosunu (booster cable) öğrenmek işe yarar.

## Evde sıcak kalmak

- Pencere kenarlarındaki hava sızıntılarını **conta/izolasyon bandıyla** kapatın.
- Termostatı akıllı kullanın; çoğu evde programlanabilir termostat ısıtma faturasını ciddi düşürür.
- Nemlendirici, kuru kış havasında hem cilt hem boğaz için rahatlatıcıdır.
