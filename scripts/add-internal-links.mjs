...
const linksBySlug = {
  'cifte-vatandaslik-pasaport-askerlik': [
    ['Çifte vatandaşlıkta seyahat ve pasaport', 'kanada-cifte-vatandas-seyahat-pasaport-rehberi'],
    ['Kanada’dan Türk pasaportu yenileme', 'kanadada-turk-pasaportu-basvuru-yenileme-rehberi'],
  ],
  ...
  'ilk-kanada-kisina-hazirlik': [
    ['Kış fırtınası ve blizzard güvenliği', 'kanada-kis-firtinasi-blizzard-guvenlik-rehberi'],
    ['Wind chill, donma ve hipotermi', 'kanada-wind-chill-donma-hipotermi-rehberi'],
  ],
  'is-teklifi-lmia-calisma-izni-rehberi': [
    ['İşveren değiştirirken çalışma izni', 'kanada-isveren-degistirme-calisma-izni-rehberi'],
    ['Francophone Mobility çalışma izni', 'kanada-francophone-mobility-calisma-izni-rehberi'],
  ],
  'kanada-bankacilik-kredi-skoru': [
    ['Kredi raporu hatası ve dolandırıcılık', 'kanada-kredi-raporu-hata-dolandiricilik-rehberi'],
    ['Yeni gelenler için TFSA katkı hakkı', 'kanada-yeni-gelenler-tfsa-katki-hakki-rehberi'],
  ],
  'kanada-egitim-izni-pgwp-rehberi': [
    ['Study permit uzatma ve DLI değişikliği', 'kanada-study-permit-uzatma-dli-degisikligi-rehberi'],
    ['Öğrenci kredisi RAP geri ödeme', 'kanada-student-loan-rap-geri-odeme-rehberi'],
  ],
  'kanada-ehliyet-degisimi': [
    ['İkinci el araçta lien ve recall kontrolü', 'kanada-ikinci-el-arac-alma-lien-recall-kontrolu'],
  ...
  'kanada-saglik-sistemi-yeni-gelenler': [
    ...
    ['Yurt dışı seyahat sağlık sigortası', 'kanada-yurtdisi-seyahat-saglik-sigortasi-rehberi'],
  ],
  ...
  'sin-numarasi-basvurusu': [
    ['SIN kimlik hırsızlığı ve veri ihlali', 'kanada-sin-kimlik-hirsizligi-veri-ihlali-rehberi'],
    ['Yeni gelenin ilk 30 günü', 'yeni-gelen-ilk-30-gun-kontrol-listesi'],
  ],
  ...
  'turkiye-kanada-ticaret-rehberi': [
    ['Kanada-Türkiye serbest ticaret müzakereleri', 'kanada-turkiye-serbest-ticaret-anlasmasi-muzakereleri-2026'],
    ['Kanada’dan Türkiye’ye para transferi', 'kanadadan-turkiyeye-para-transferi-rehberi'],
  ],
...
for (const [slug, links] of Object.entries(linksBySlug)) {
  ...
  for (const [, target] of links) {
    if (!fs.existsSync(path.join(articleDir, `${target}.md`))) throw new Error(`Broken target ${target} for ${slug}`);
  }
